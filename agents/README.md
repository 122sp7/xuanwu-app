...
For the formal Copilot delivery workflow, see [docs/development-reference/reference/ai/customizations-index.md](../docs/development-reference/reference/ai/customizations-index.md) and [docs/how-to-user/how-to/ai/start-feature-delivery.md](../docs/how-to-user/how-to/ai/start-feature-delivery.md).
