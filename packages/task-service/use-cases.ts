/**
 * Task use-cases — pure orchestration classes.
 *
 * These are the SOURCE OF TRUTH for task business logic.
 * No Firebase, no HTTP, no React — only @task-core ports + @shared-types.
 *
 * Consumers inject a TaskRepository implementation at construction time.
 */
