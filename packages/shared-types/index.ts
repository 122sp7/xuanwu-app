 ...
 * Core shared domain types used across all modules.
 *
 * This package is the single source of truth for:
 *   - Primitive domain types (ID, Pagination)
 *   - CommandResult discriminated union contract
 *   - DomainError structured error type
 *   - Firestore Timestamp shim
 *   - Common utility functions (formatDate, generateId)
 *
 * Dependency rule: This package has ZERO external dependencies.
 * It may only depend on built-in TypeScript/JavaScript primitives.
 *
 * Usage:
 *   import { CommandResult, commandSuccess, commandFailureFrom } from "@shared-types";
 */
