 ...
 * All Firebase download-URL resolution happens in the caller;
 * this component only receives an already-resolved HTTPS URL.
 *
 * Placed in integration-google because the embed-URL construction
 * (createGoogleViewerEmbedUrl) and this modal are inseparable concerns of the
 * Google Docs Viewer surface. Consumers import both from '@packages'.
 */
      ...
      <div className="relative flex h-[85vh] w-full max-w-4xl flex-col overflow-hidden rounded-xl bg-background shadow-2xl">
        ...
        <div className="flex shrink-0 items-center justify-between border-b border-border/40 px-4 py-2.5">
          <div className="flex items-center gap-2">
            ...
            <span className="max-w-xs truncate text-sm font-medium">{name}</span>
