...
此套件是 **Google 服務整合的唯一封裝層**：Google Docs Viewer URL 建構、MIME 類型白名單。
...
| React UI 預覽 Modal 元件 | `src/modules/notebooklm/adapters/inbound/react/` |
...
// ✅ 透過此套件
import { createGoogleViewerEmbedUrl } from '@packages'
```
