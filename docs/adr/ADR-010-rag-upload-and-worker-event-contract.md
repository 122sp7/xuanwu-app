...
2. `lib/firebase/functions-python/docs/adr/ADR-004-structure-and-interaction-design.md` 與 `ADR-006-enterprise-rag-end-to-end-pipeline.md` 定義 worker 內部流程與觸發方向。
