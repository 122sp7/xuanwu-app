...
| --- | --- | --- | --- |
| [RAG ingestion contract](./rag-ingestion-contract.md) | `modules/file` + `modules/ai` + `py_fn` | Cross-runtime upload, worker, and retrieval boundary | ADR drift and upload-to-worker trigger mismatch |
