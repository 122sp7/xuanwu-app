...
| [Knowledge contract](./knowledge-contract.md) | `modules/knowledge` | Read-side knowledge summary + visible workspace UI + MVP write-side alignment | Clarifies UI/UX acceptance and maps summary posture to architecture lifecycle without ownership drift |
