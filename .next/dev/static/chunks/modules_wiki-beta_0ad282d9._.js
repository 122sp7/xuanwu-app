...
"[project]/modules/wiki-beta/infrastructure/repositories/firebase-wiki-beta.repository.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class FirebaseWikiBetaContentRepository {
    async runRagQuery(query, accountId, workspaceId, topK, options = {}) {
        const functions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$integration$2d$firebase$2f$functions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFirebaseFunctions"])("asia-southeast1");
        const callable = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$integration$2d$firebase$2f$functions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["functionsApi"].httpsCallable(functions, "rag_query");
    ...
    async reindexDocument(input) {
        const functions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$integration$2d$firebase$2f$functions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFirebaseFunctions"])("asia-southeast1");
        const callable = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$integration$2d$firebase$2f$functions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["functionsApi"].httpsCallable(functions, "rag_reindex_document");
        await callable({
    ...
    async listParsedDocuments(accountId, limitCount) {
        ...
        const accountRef = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$integration$2d$firebase$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["firestoreApi"].collection(db, "accounts", accountId, "documents");
        const accountQuery = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$integration$2d$firebase$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["firestoreApi"].query(accountRef, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$integration$2d$firebase$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["firestoreApi"].limit(limitCount));
        const accountSnap = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$integration$2d$firebase$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["firestoreApi"].getDocs(accountQuery);
...
class FirebaseWikiBetaWorkspaceRepository {
    async listByAccountId(accountId) {
        const workspaces = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$workspace$2f$interfaces$2f$queries$2f$workspace$2e$queries$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getWorkspacesForAccount"])(accountId);
...
"[project]/modules/wiki-beta/infrastructure/repositories/firebase-wiki-beta-page.repository.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class FirebaseWikiBetaPageRepository {
    async listByAccountId(accountId) {
        const db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$integration$2d$firebase$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFirebaseFirestore"])();
        const ref = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$integration$2d$firebase$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["firestoreApi"].collection(db, "accounts", accountId, "pages");
        const snap = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$integration$2d$firebase$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["firestoreApi"].getDocs(ref);
    ...
    async findById(accountId, pageId) {
        const db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$integration$2d$firebase$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFirebaseFirestore"])();
        const ref = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$integration$2d$firebase$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["firestoreApi"].doc(db, "accounts", accountId, "pages", pageId);
        const snap = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$integration$2d$firebase$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["firestoreApi"].getDoc(ref);
        if (!snap.exists()) {
            return null;
        }
        const raw = snap.data();
    ...
    async create(page) {
        const db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$integration$2d$firebase$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFirebaseFirestore"])();
        const ref = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$integration$2d$firebase$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["firestoreApi"].doc(db, "accounts", page.accountId, "pages", page.id);
        await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$integration$2d$firebase$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["firestoreApi"].setDoc(ref, mapForWrite(page));
    }
    async update(page) {
        const db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$integration$2d$firebase$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFirebaseFirestore"])();
        const ref = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$integration$2d$firebase$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["firestoreApi"].doc(db, "accounts", page.accountId, "pages", page.id);
        await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$integration$2d$firebase$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["firestoreApi"].updateDoc(ref, {
            workspaceId: page.workspaceId ?? null,
            title: page.title,
            slug: page.slug,
            parentPageId: page.parentPageId,
...
"[project]/modules/wiki-beta/infrastructure/repositories/in-memory-wiki-beta-page.repository.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/modules/wiki-beta/infrastructure/repositories/in-memory-wiki-beta-library.repository.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/modules/wiki-beta/infrastructure/index.ts [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$wiki$2d$beta$2f$infrastructure$2f$repositories$2f$firebase$2d$wiki$2d$beta$2e$repository$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/modules/wiki-beta/infrastructure/repositories/firebase-wiki-beta.repository.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$wiki$2d$beta$2f$infrastructure$2f$repositories$2f$firebase$2d$wiki$2d$beta$2d$page$2e$repository$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/modules/wiki-beta/infrastructure/repositories/firebase-wiki-beta-page.repository.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$wiki$2d$beta$2f$infrastructure$2f$repositories$2f$in$2d$memory$2d$wiki$2d$beta$2d$page$2e$repository$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/modules/wiki-beta/infrastructure/repositories/in-memory-wiki-beta-page.repository.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$wiki$2d$beta$2f$infrastructure$2f$repositories$2f$in$2d$memory$2d$wiki$2d$beta$2d$library$2e$repository$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/modules/wiki-beta/infrastructure/repositories/in-memory-wiki-beta-library.repository.ts [app-client] (ecmascript)");
;
;
;
;
...
"[project]/modules/wiki-beta/application/use-cases/wiki-beta-rag.use-case.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$wiki$2d$beta$2f$infrastructure$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/modules/wiki-beta/infrastructure/index.ts [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$wiki$2d$beta$2f$infrastructure$2f$repositories$2f$firebase$2d$wiki$2d$beta$2e$repository$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/modules/wiki-beta/infrastructure/repositories/firebase-wiki-beta.repository.ts [app-client] (ecmascript)");
;
const defaultContentRepository = new __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$wiki$2d$beta$2f$infrastructure$2f$repositories$2f$firebase$2d$wiki$2d$beta$2e$repository$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FirebaseWikiBetaContentRepository"]();
...
"[project]/modules/wiki-beta/application/use-cases/wiki-beta-pages.use-case.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$event$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/modules/event/index.ts [app-client] (ecmascript) <locals>");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$namespace$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/modules/namespace/index.ts [app-client] (ecmascript) <locals>");
...
;
;
const defaultPageRepository = new __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$wiki$2d$beta$2f$infrastructure$2f$repositories$2f$firebase$2d$wiki$2d$beta$2d$page$2e$repository$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FirebaseWikiBetaPageRepository"]();
const defaultEventPublisher = new __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$event$2f$application$2f$use$2d$cases$2f$publish$2d$domain$2d$event$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PublishDomainEventUseCase"](new __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$event$2f$infrastructure$2f$repositories$2f$in$2d$memory$2d$event$2d$store$2e$repository$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InMemoryEventStoreRepository"](), new __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$event$2f$infrastructure$2f$repositories$2f$noop$2d$event$2d$bus$2e$repository$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NoopEventBusRepository"]());
function generateId() {
...
function ensureUniqueSlug(baseSlug, siblingPages) {
    const normalizedBase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$namespace$2f$domain$2f$services$2f$slug$2d$policy$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isValidSlug"])(baseSlug) ? baseSlug : "page-node";
    ...
    while(index < 5000){
        ...
        if (!existing.has(candidate) && (0, __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$namespace$2f$domain$2f$services$2f$slug$2d$policy$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isValidSlug"])(candidate)) {
            return candidate;
        }
        index += 1;
    }
...
async function createWikiBetaPage(input, pageRepository = defaultPageRepository) {
    ...
    const rawSlug = (0, __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$namespace$2f$domain$2f$services$2f$slug$2d$policy$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deriveSlugCandidate"])(title);
...
async function renameWikiBetaPage(input, pageRepository = defaultPageRepository) {
    ...
    const slug = ensureUniqueSlug((0, __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$namespace$2f$domain$2f$services$2f$slug$2d$policy$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deriveSlugCandidate"])(title), siblingPages);
    const updated = {
        ...existing,
        title,
        slug,
...
"[project]/modules/wiki-beta/application/use-cases/wiki-beta-libraries.use-case.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const defaultLibraryRepository = new __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$wiki$2d$beta$2f$infrastructure$2f$repositories$2f$in$2d$memory$2d$wiki$2d$beta$2d$library$2e$repository$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InMemoryWikiBetaLibraryRepository"]();
const defaultEventPublisher = new __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$event$2f$application$2f$use$2d$cases$2f$publish$2d$domain$2d$event$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PublishDomainEventUseCase"](new __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$event$2f$infrastructure$2f$repositories$2f$in$2d$memory$2d$event$2d$store$2e$repository$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InMemoryEventStoreRepository"](), new __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$event$2f$infrastructure$2f$repositories$2f$noop$2d$event$2d$bus$2e$repository$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NoopEventBusRepository"]());
function generateId() {
    const randomUUID = globalThis.crypto?.randomUUID;
    if (typeof randomUUID === "function") {
...
function ensureUniqueLibrarySlug(baseSlug, libraries) {
    const normalizedBase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$namespace$2f$domain$2f$services$2f$slug$2d$policy$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isValidSlug"])(baseSlug) ? baseSlug : "library-node";
...
async function createWikiBetaLibrary(input, libraryRepository = defaultLibraryRepository) {
    ...
    const slug = ensureUniqueLibrarySlug((0, __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$namespace$2f$domain$2f$services$2f$slug$2d$policy$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deriveSlugCandidate"])(name), workspaceLibraries);
    const now = new Date();
    const library = {
        id: generateId(),
        accountId: input.accountId,
...
"[project]/modules/wiki-beta/application/use-cases/wiki-beta-content-tree.use-case.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$wiki$2d$beta$2f$infrastructure$2f$repositories$2f$firebase$2d$wiki$2d$beta$2e$repository$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/modules/wiki-beta/infrastructure/repositories/firebase-wiki-beta.repository.ts [app-client] (ecmascript)");
;
const defaultWorkspaceRepository = new __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$wiki$2d$beta$2f$infrastructure$2f$repositories$2f$firebase$2d$wiki$2d$beta$2e$repository$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FirebaseWikiBetaWorkspaceRepository"]();
...
"[project]/modules/wiki-beta/interfaces/components/WikiBetaRagView.tsx [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([]);
// Moved to modules/retrieval as RagView. Transitional re-export during wiki-beta decomposition.
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$retrieval$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/modules/retrieval/api/index.ts [app-client] (ecmascript) <locals>");
;
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/modules/wiki-beta/interfaces/components/WikiBetaWorkspaceView.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$wiki$2d$beta$2f$interfaces$2f$components$2f$WikiBetaRagView$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/modules/wiki-beta/interfaces/components/WikiBetaRagView.tsx [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$retrieval$2f$interfaces$2f$components$2f$RagView$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__RagView__as__WikiBetaRagView$3e$__ = __turbopack_context__.i("[project]/modules/retrieval/interfaces/components/RagView.tsx [app-client] (ecmascript) <export RagView as WikiBetaRagView>");
"use client";
;
;
;
...
function WikiBetaWorkspaceView({ workspace }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$retrieval$2f$interfaces$2f$components$2f$RagView$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__RagView__as__WikiBetaRagView$3e$__["WikiBetaRagView"], {
                onBack: ()=>undefined,
...
_c = WikiBetaWorkspaceView;
var _c;
__turbopack_context__.k.register(_c, "WikiBetaWorkspaceView");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/modules/wiki-beta/interfaces/components/WikiBetaOverviewView.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$ui$2d$shadcn$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/ui-shadcn/ui/card.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$ui$2d$shadcn$2f$ui$2f$skeleton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/ui-shadcn/ui/skeleton.tsx [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$wiki$2d$beta$2f$application$2f$use$2d$cases$2f$wiki$2d$beta$2d$content$2d$tree$2e$use$2d$case$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/modules/wiki-beta/application/use-cases/wiki-beta-content-tree.use-case.ts [app-client] (ecmascript)");
;
...
function WikiBetaOverviewView() {
    ...
    const [contentTree, setContentTree] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const accountSeeds = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "WikiBetaOverviewView.useMemo[accountSeeds]": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WikiBetaOverviewView.useEffect": ()=>{
            let disposed = false;
            async function load() {
                setLoading(true);
                try {
                    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$wiki$2d$beta$2f$application$2f$use$2d$cases$2f$wiki$2d$beta$2d$content$2d$tree$2e$use$2d$case$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildWikiBetaContentTree"])(accountSeeds);
                    if (!disposed) {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$ui$2d$shadcn$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$ui$2d$shadcn$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                        className: "space-y-3",
                        children: [
                            loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$ui$2d$shadcn$2f$ui$2f$skeleton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Skeleton"], {
                                className: "h-6 w-48"
                            }, void 0, false, {
                                fileName: "[project]/modules/wiki-beta/interfaces/components/WikiBetaOverviewView.tsx",
                                lineNumber: 115,
                                columnNumber: 13
                            }, this) : activeAccount ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$ui$2d$shadcn$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                        children: loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            lineNumber: 167,
                            columnNumber: 13
                        }, this) : !activeAccount || activeAccount.workspaces.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            className: "text-sm text-muted-foreground",
                            children: "目前帳號下沒有工作區。"
                        }, void 0, false, {
                            fileName: "[project]/modules/wiki-beta/interfaces/components/WikiBetaOverviewView.tsx",
...
_s(WikiBetaOverviewView, "NcGR9RYYxd08MNnJIp0Jpmd/mhU=", false, function() {
    return [
...
_c = WikiBetaOverviewView;
var _c;
__turbopack_context__.k.register(_c, "WikiBetaOverviewView");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/modules/wiki-beta/interfaces/components/WikiBetaBlockEditorView.tsx [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([]);
// Moved to modules/content as BlockEditorView. Transitional re-export during wiki-beta decomposition.
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$content$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/modules/content/api/index.ts [app-client] (ecmascript) <locals>");
;
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/modules/wiki-beta/interfaces/components/WikiBetaDocumentsView.tsx [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/modules/wiki-beta/interfaces/components/WikiBetaLibrariesView.tsx [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/modules/wiki-beta/interfaces/components/WikiBetaLibraryTableView.tsx [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/modules/wiki-beta/interfaces/components/WikiBetaPagesDnDView.tsx [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/modules/wiki-beta/interfaces/components/WikiBetaPagesView.tsx [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/modules/wiki-beta/interfaces/components/WikiBetaRagQueryView.tsx [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/modules/wiki-beta/api/index.ts [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$wiki$2d$beta$2f$application$2f$use$2d$cases$2f$wiki$2d$beta$2d$rag$2e$use$2d$case$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/modules/wiki-beta/application/use-cases/wiki-beta-rag.use-case.ts [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$wiki$2d$beta$2f$interfaces$2f$components$2f$WikiBetaWorkspaceView$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/modules/wiki-beta/interfaces/components/WikiBetaWorkspaceView.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$wiki$2d$beta$2f$interfaces$2f$components$2f$WikiBetaOverviewView$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/modules/wiki-beta/interfaces/components/WikiBetaOverviewView.tsx [app-client] (ecmascript)");
// Transitional re-exports — delegate to canonical bounded-context modules
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$wiki$2d$beta$2f$interfaces$2f$components$2f$WikiBetaBlockEditorView$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/modules/wiki-beta/interfaces/components/WikiBetaBlockEditorView.tsx [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$wiki$2d$beta$2f$interfaces$2f$components$2f$WikiBetaDocumentsView$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/modules/wiki-beta/interfaces/components/WikiBetaDocumentsView.tsx [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$wiki$2d$beta$2f$interfaces$2f$components$2f$WikiBetaLibrariesView$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/modules/wiki-beta/interfaces/components/WikiBetaLibrariesView.tsx [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$wiki$2d$beta$2f$interfaces$2f$components$2f$WikiBetaLibraryTableView$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/modules/wiki-beta/interfaces/components/WikiBetaLibraryTableView.tsx [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$wiki$2d$beta$2f$interfaces$2f$components$2f$WikiBetaPagesDnDView$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/modules/wiki-beta/interfaces/components/WikiBetaPagesDnDView.tsx [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$wiki$2d$beta$2f$interfaces$2f$components$2f$WikiBetaPagesView$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/modules/wiki-beta/interfaces/components/WikiBetaPagesView.tsx [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$wiki$2d$beta$2f$interfaces$2f$components$2f$WikiBetaRagQueryView$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/modules/wiki-beta/interfaces/components/WikiBetaRagQueryView.tsx [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$wiki$2d$beta$2f$interfaces$2f$components$2f$WikiBetaRagView$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/modules/wiki-beta/interfaces/components/WikiBetaRagView.tsx [app-client] (ecmascript) <locals>");
;
;
;
...
//# sourceMappingURL=modules_wiki-beta_0ad282d9._.js.map