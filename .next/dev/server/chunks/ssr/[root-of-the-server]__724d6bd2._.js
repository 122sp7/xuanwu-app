...
"[project]/modules/identity/api/index.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
// ─── 內部單例 ──────────────────────────────────────────────────────────────────
const tokenRefreshRepo = new __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$identity$2f$infrastructure$2f$firebase$2f$FirebaseTokenRefreshRepository$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["FirebaseTokenRefreshRepository"]();
const emitUseCase = new __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$identity$2f$application$2f$use$2d$cases$2f$token$2d$refresh$2e$use$2d$cases$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EmitTokenRefreshSignalUseCase"](tokenRefreshRepo);
const identityApi = {
    /**
...
"[project]/modules/account/application/use-cases/account.use-cases.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2d$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/shared-types/index.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$identity$2f$api$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/modules/identity/api/index.ts [app-ssr] (ecmascript)");
;
;
class CreateUserAccountUseCase {
    ...
    async execute(userId, name, email) {
        try {
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2d$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["commandSuccess"])(userId, Date.now());
        } catch (err) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2d$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["commandFailureFrom"])("CREATE_USER_ACCOUNT_FAILED", err instanceof Error ? err.message : "Failed to create user account");
        }
    }
}
class UpdateUserProfileUseCase {
    ...
    async execute(userId, data) {
        try {
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2d$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["commandFailureFrom"])("UPDATE_USER_PROFILE_FAILED", err instanceof Error ? err.message : "Failed to update user profile");
        }
    }
}
class CreditWalletUseCase {
    ...
    async execute(accountId, amount, description) {
        try {
            if (amount <= 0) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2d$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["commandFailureFrom"])("WALLET_INVALID_AMOUNT", "Credit amount must be positive");
            }
            const tx = await this.accountRepo.creditWallet(accountId, amount, description);
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2d$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["commandSuccess"])(tx.id, Date.now());
        } catch (err) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2d$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["commandFailureFrom"])("WALLET_CREDIT_FAILED", err instanceof Error ? err.message : "Failed to credit wallet");
        }
    }
}
class DebitWalletUseCase {
    ...
    async execute(accountId, amount, description) {
        try {
            if (amount <= 0) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2d$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["commandFailureFrom"])("WALLET_INVALID_AMOUNT", "Debit amount must be positive");
            }
            const balance = await this.accountRepo.getWalletBalance(accountId);
            if (balance < amount) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2d$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["commandFailureFrom"])("WALLET_INSUFFICIENT_FUNDS", "Insufficient wallet balance");
            }
            const tx = await this.accountRepo.debitWallet(accountId, amount, description);
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2d$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["commandSuccess"])(tx.id, Date.now());
        } catch (err) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2d$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["commandFailureFrom"])("WALLET_DEBIT_FAILED", err instanceof Error ? err.message : "Failed to debit wallet");
        }
    }
}
class AssignAccountRoleUseCase {
    ...
    async execute(accountId, role, grantedBy, traceId) {
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$identity$2f$api$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["identityApi"].emitTokenRefreshSignal({
                accountId,
                reason: "role:changed",
                ...traceId ? {
                    traceId
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2d$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["commandSuccess"])(record.accountId, Date.now());
        } catch (err) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2d$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["commandFailureFrom"])("ASSIGN_ROLE_FAILED", err instanceof Error ? err.message : "Failed to assign role");
        }
    }
}
class RevokeAccountRoleUseCase {
    ...
    async execute(accountId) {
        try {
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2d$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["commandSuccess"])(accountId, Date.now());
        } catch (err) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2d$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["commandFailureFrom"])("REVOKE_ROLE_FAILED", err instanceof Error ? err.message : "Failed to revoke role");
        }
    }
}
}),
"[project]/modules/account/application/use-cases/account-policy.use-cases.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class CreateAccountPolicyUseCase {
    ...
    async execute(input) {
        try {
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2d$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["commandFailureFrom"])("CREATE_ACCOUNT_POLICY_FAILED", err instanceof Error ? err.message : "Failed to create account policy");
        }
    }
}
class UpdateAccountPolicyUseCase {
    ...
    async execute(policyId, accountId, data) {
        try {
            ...
            if (!existing) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2d$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["commandFailureFrom"])("ACCOUNT_POLICY_NOT_FOUND", `Policy ${policyId} not found`);
            }
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2d$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["commandFailureFrom"])("UPDATE_ACCOUNT_POLICY_FAILED", err instanceof Error ? err.message : "Failed to update account policy");
        }
    }
}
class DeleteAccountPolicyUseCase {
    ...
    async execute(policyId, accountId) {
        try {
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2d$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["commandFailureFrom"])("DELETE_ACCOUNT_POLICY_FAILED", err instanceof Error ? err.message : "Failed to delete account policy");
        }
    }
}
}),
"[project]/modules/account/infrastructure/firebase/FirebaseAccountRepository.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class FirebaseAccountRepository {
    ...
    async creditWallet(accountId, amount, description) {
        const db = this.db;
        const accountRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doc"])(db, "accounts", accountId);
        let txId;
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["runTransaction"])(db, async (txn)=>{
        ...
        // Append ledger entry
        const txRef = await __turbopack_context__.A("[project]/node_modules/firebase/firestore/dist/index.mjs [app-ssr] (ecmascript, async loader)").then(async ({ addDoc })=>{
            txId = crypto.randomUUID();
            return addDoc((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["collection"])(db, "accounts", accountId, "walletTransactions"), {
                id: txId,
                accountId,
                type: "credit",
                amount,
                reason: description,
                occurredAt: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["serverTimestamp"])()
            });
        });
        return {
            id: txRef.id,
    ...
    async debitWallet(accountId, amount, description) {
        ...
        const txRef = await __turbopack_context__.A("[project]/node_modules/firebase/firestore/dist/index.mjs [app-ssr] (ecmascript, async loader)").then(async ({ addDoc })=>addDoc((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["collection"])(db, "accounts", accountId, "walletTransactions"), {
                accountId,
                type: "debit",
                amount,
                reason: description,
...
"[project]/modules/account/index.ts [app-ssr] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

/**
 * account module public API
 */ __turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$account$2f$application$2f$use$2d$cases$2f$account$2e$use$2d$cases$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/modules/account/application/use-cases/account.use-cases.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$account$2f$application$2f$use$2d$cases$2f$account$2d$policy$2e$use$2d$cases$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/modules/account/application/use-cases/account-policy.use-cases.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$account$2f$infrastructure$2f$firebase$2f$FirebaseAccountRepository$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/modules/account/infrastructure/firebase/FirebaseAccountRepository.ts [app-ssr] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$identity$2f$infrastructure$2f$firebase$2f$FirebaseIdentityRepository$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/modules/identity/infrastructure/firebase/FirebaseIdentityRepository.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$identity$2f$application$2f$use$2d$cases$2f$identity$2e$use$2d$cases$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/modules/identity/application/use-cases/identity.use-cases.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$account$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/modules/account/index.ts [app-ssr] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$account$2f$application$2f$use$2d$cases$2f$account$2e$use$2d$cases$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/modules/account/application/use-cases/account.use-cases.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$account$2f$infrastructure$2f$firebase$2f$FirebaseAccountRepository$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/modules/account/infrastructure/firebase/FirebaseAccountRepository.ts [app-ssr] (ecmascript)");
...
;
function PublicPage() {
    const { state, dispatch } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$providers$2f$auth$2d$provider$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const [isAuthPanelOpen, setIsAuthPanelOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const { signInUseCase, signInAnonymouslyUseCase, registerUseCase, sendPasswordResetEmailUseCase, createUserAccountUseCase } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        const identityRepo = new __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$identity$2f$infrastructure$2f$firebase$2f$FirebaseIdentityRepository$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["FirebaseIdentityRepository"]();
        const accountRepo = new __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$account$2f$infrastructure$2f$firebase$2f$FirebaseAccountRepository$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["FirebaseAccountRepository"]();
        return {
            signInUseCase: new __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$identity$2f$application$2f$use$2d$cases$2f$identity$2e$use$2d$cases$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SignInUseCase"](identityRepo),
            signInAnonymouslyUseCase: new __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$identity$2f$application$2f$use$2d$cases$2f$identity$2e$use$2d$cases$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SignInAnonymouslyUseCase"](identityRepo),
            registerUseCase: new __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$identity$2f$application$2f$use$2d$cases$2f$identity$2e$use$2d$cases$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["RegisterUseCase"](identityRepo),
            sendPasswordResetEmailUseCase: new __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$identity$2f$application$2f$use$2d$cases$2f$identity$2e$use$2d$cases$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SendPasswordResetEmailUseCase"](identityRepo),
            createUserAccountUseCase: new __TURBOPACK__imported__module__$5b$project$5d2f$modules$2f$account$2f$application$2f$use$2d$cases$2f$account$2e$use$2d$cases$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CreateUserAccountUseCase"](accountRepo)
        };
    }, []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
    ...
    async function handleSubmit(e) {
        ...
        setIsLoading(true);
        try {
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$providers$2f$dev$2d$demo$2d$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isLocalDevDemoAllowed"])() && tab === "login" && (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$providers$2f$dev$2d$demo$2d$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isDevDemoCredential"])(email, password)) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$providers$2f$dev$2d$demo$2d$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["writeDevDemoSession"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$providers$2f$dev$2d$demo$2d$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createDevDemoUser"])());
        ...
        try {
            ...
            if (!result.success) {
                ...
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$providers$2f$dev$2d$demo$2d$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isLocalDevDemoAllowed"])()) {
                    const guestUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$providers$2f$dev$2d$demo$2d$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createDevDemoUser"])();
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$providers$2f$dev$2d$demo$2d$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["writeDevDemoSession"])(guestUser);
                    dispatch({
                        type: "SET_AUTH_STATE",
                        payload: {
                            user: guestUser,
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                ...
                children: [
                    ...
                    isAuthPanelOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            tab === "login" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                type: "button",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__724d6bd2._.js.map