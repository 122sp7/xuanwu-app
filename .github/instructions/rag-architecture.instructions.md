...
applyTo: '{src/modules/notebooklm/**/*.{ts,tsx,js,jsx},src/modules/notion/**/*.{ts,tsx,js,jsx},fn/**/*.py,docs/**/*.md}'
---
...
- Keep runtime split: Next.js orchestration, `fn` ingestion pipeline.
