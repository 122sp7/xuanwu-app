...
modules/platform/interfaces/web/shell/navigation/data/ShellSidebarNavData.tsx (132 lines)
...
modules/platform/subdomains/platform-config/application/index.ts (13 lines)
modules/platform/subdomains/platform-config/application/services/shell-navigation-catalog.ts (114 lines)
