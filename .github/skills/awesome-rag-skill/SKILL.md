---
name: awesome-rag-skill
description: Reference codebase for Awesome RAG. Use this skill when you need to understand the structure, implementation patterns, or code details of the Awesome RAG project.
---

# Awesome RAG Codebase Reference

4 files | 913 lines | 13252 tokens
...
This skill was generated by [Repomix](https://github.com/yamadashy/repomix) from [Awesome RAG](Danielskry/Awesome-RAG)
