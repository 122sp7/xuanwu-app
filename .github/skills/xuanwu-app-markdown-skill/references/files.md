...
## File: modules/workspace/domain/ports/input/AGENT.md
````markdown
...
## File: modules/workspace/domain/ports/output/AGENT.md
````markdown
...
## File: modules/workspace/domain/ports/README.md
````markdown
# workspace ports
