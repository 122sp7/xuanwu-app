...
> **Canonical DDD reference:** `../../docs/ddd/account/application-services.md`

本文件對齊 `docs/ddd/account/application-services.md`，整理 `account` 的 application layer orchestrators、use cases、DTO 與 process managers。
...
- `../../docs/ddd/account/application-services.md`
- `./repositories.md`
- `./domain-services.md`
````
...
> **Canonical DDD reference:** `../../docs/ddd/account/domain-services.md`

本文件對齊 `docs/ddd/account/domain-services.md`，整理 `account` 的 domain services 與相關設計約束。
...
- `../../docs/ddd/account/domain-services.md`
- `../../docs/ddd/account/aggregates.md`
````
...
> **Canonical DDD reference:** `../../docs/ddd/account/repositories.md`

本文件對齊 `docs/ddd/account/repositories.md`，整理 `account` 的 repository ports 與 infrastructure 實作。
...
- `../../docs/ddd/account/repositories.md`
...
> **Canonical DDD reference:** `../../docs/ddd/ai/context-map.md`

本文件對齊 `docs/ddd/ai/context-map.md`，作為 `ai` 在模組目錄中的整合關係速查表。

## Integration Notes

- 上游：source 事件
- 下游：search、py_fn/ runtime
...
> **Canonical DDD reference:** `../../docs/ddd/identity/aggregates.md`

本文件對齊 `docs/ddd/identity/aggregates.md`，作為 `identity` 在模組目錄中的聚合根 / 實體 / 值物件索引。

## 設計摘要

- `identity` 的聚合設計、生命週期與不變數以 canonical DDD 文件為準
- 模組內部程式碼導覽以下列路徑為主
...
> **Canonical DDD reference:** `../../docs/ddd/identity/domain-events.md`

本文件對齊 `docs/ddd/identity/domain-events.md`，作為 `identity` 的事件程式碼入口索引。
...
- `../../docs/ddd/identity/domain-events.md`
- `../../docs/ddd/identity/context-map.md`
````
...
> **Canonical DDD reference:** `../../docs/ddd/identity/domain-services.md`

本文件對齊 `docs/ddd/identity/domain-services.md`，整理 `identity` 的 domain services 與相關設計約束。
...
- `../../docs/ddd/identity/domain-services.md`
- `../../docs/ddd/identity/aggregates.md`
````
...
> **Canonical DDD reference:** `../../docs/ddd/knowledge/domain-events.md`

本文件對齊 `docs/ddd/knowledge/domain-events.md`，作為 `knowledge` 的事件程式碼入口索引。
...
- `../../docs/ddd/knowledge/domain-events.md`
- `../../docs/ddd/knowledge/context-map.md`
````
...
> **Canonical DDD reference:** `../../docs/ddd/knowledge/domain-services.md`

本文件對齊 `docs/ddd/knowledge/domain-services.md`，整理 `knowledge` 的 domain services 與相關設計約束。
...
- `../../docs/ddd/knowledge/domain-services.md`
- `../../docs/ddd/knowledge/aggregates.md`
````
...
> **Canonical DDD reference:** `../../docs/ddd/notebook/aggregates.md`

本文件對齊 `docs/ddd/notebook/aggregates.md`，作為 `notebook` 在模組目錄中的聚合根 / 實體 / 值物件索引。

## 設計摘要

- `notebook` 的聚合設計、生命週期與不變數以 canonical DDD 文件為準
- 模組內部程式碼導覽以下列路徑為主

## Entities / Aggregates
- `domain/entities/AgentGeneration.ts`
- `domain/entities/RagQuery.ts`
- `domain/entities/message.ts`
- `domain/entities/thread.ts`
...
> **Canonical DDD reference:** `../../docs/ddd/notebook/domain-events.md`

本文件對齊 `docs/ddd/notebook/domain-events.md`，作為 `notebook` 的事件程式碼入口索引。
...
- `../../docs/ddd/notebook/domain-events.md`
- `../../docs/ddd/notebook/context-map.md`
````
...
> **Canonical DDD reference:** `../../docs/ddd/notebook/domain-services.md`

本文件對齊 `docs/ddd/notebook/domain-services.md`，整理 `notebook` 的 domain services 與相關設計約束。
...
````markdown
# notebook — Ubiquitous Language

> **Canonical DDD reference:** `../../docs/ddd/notebook/ubiquitous-language.md`

本文件是 `notebook` 的模組就地導覽版本，命名、術語與定義以 `docs/ddd/notebook/ubiquitous-language.md` 為準。

## 使用規則

- 新增 class / type / variable 前，先對照 canonical 術語
- 跨模組傳遞的公開名詞，必須與 `docs/ddd/notebook/` 保持一致
- 若術語變更，先更新 `docs/ddd/notebook/ubiquitous-language.md`，再同步此文件
...
> **Canonical DDD reference:** `../../docs/ddd/notification/application-services.md`

本文件對齊 `docs/ddd/notification/application-services.md`，整理 `notification` 的 application layer orchestrators、use cases、DTO 與 process managers。
...
- `../../docs/ddd/notification/application-services.md`
- `./repositories.md`
- `./domain-services.md`
````
...
````markdown
# notification — Ubiquitous Language

> **Canonical DDD reference:** `../../docs/ddd/notification/ubiquitous-language.md`

本文件是 `notification` 的模組就地導覽版本，命名、術語與定義以 `docs/ddd/notification/ubiquitous-language.md` 為準。

## 使用規則

- 新增 class / type / variable 前，先對照 canonical 術語
- 跨模組傳遞的公開名詞，必須與 `docs/ddd/notification/` 保持一致
- 若術語變更，先更新 `docs/ddd/notification/ubiquitous-language.md`，再同步此文件
...
> **Canonical DDD reference:** `../../docs/ddd/organization/domain-services.md`

本文件對齊 `docs/ddd/organization/domain-services.md`，整理 `organization` 的 domain services 與相關設計約束。
...
- `../../docs/ddd/organization/domain-services.md`
- `../../docs/ddd/organization/aggregates.md`
````
...
> **Canonical DDD reference:** `../../docs/ddd/search/domain-services.md`

本文件對齊 `docs/ddd/search/domain-services.md`，整理 `search` 的 domain services 與相關設計約束。
...
- `../../docs/ddd/search/domain-services.md`
- `../../docs/ddd/search/aggregates.md`
````
...
> **Canonical DDD reference:** `../../docs/ddd/shared/domain-services.md`

本文件對齊 `docs/ddd/shared/domain-services.md`，整理 `shared` 的 domain services 與相關設計約束。
...
- `../../docs/ddd/shared/domain-services.md`
- `../../docs/ddd/shared/aggregates.md`
````
...
> **Canonical DDD reference:** `../../docs/ddd/shared/ubiquitous-language.md`

本文件是 `shared` 的模組就地導覽版本，命名、術語與定義以 `docs/ddd/shared/ubiquitous-language.md` 為準。

## 使用規則

- 新增 class / type / variable 前，先對照 canonical 術語
- 跨模組傳遞的公開名詞，必須與 `docs/ddd/shared/` 保持一致
- 若術語變更，先更新 `docs/ddd/shared/ubiquitous-language.md`，再同步此文件
...
> **Canonical DDD reference:** `../../docs/ddd/source/aggregates.md`

本文件對齊 `docs/ddd/source/aggregates.md`，作為 `source` 在模組目錄中的聚合根 / 實體 / 值物件索引。

## 設計摘要

- `source` 的聚合設計、生命週期與不變數以 canonical DDD 文件為準
- 模組內部程式碼導覽以下列路徑為主
...
> **Canonical DDD reference:** `../../docs/ddd/wiki/application-services.md`

本文件對齊 `docs/ddd/wiki/application-services.md`，整理 `wiki` 的 application layer orchestrators、use cases、DTO 與 process managers。
...
- `../../docs/ddd/wiki/application-services.md`
- `./repositories.md`
- `./domain-services.md`
````
...
> **Canonical DDD reference:** `../../docs/ddd/wiki/domain-services.md`

本文件對齊 `docs/ddd/wiki/domain-services.md`，整理 `wiki` 的 domain services 與相關設計約束。
...
- `../../docs/ddd/wiki/domain-services.md`
- `../../docs/ddd/wiki/aggregates.md`
````
...
> **Canonical DDD reference:** `../../docs/ddd/wiki/repositories.md`

本文件對齊 `docs/ddd/wiki/repositories.md`，整理 `wiki` 的 repository ports 與 infrastructure 實作。
...
> **Canonical DDD reference:** `../../docs/ddd/workspace-audit/domain-services.md`

本文件對齊 `docs/ddd/workspace-audit/domain-services.md`，整理 `workspace-audit` 的 domain services 與相關設計約束。
...
- `../../docs/ddd/workspace-audit/domain-services.md`
- `../../docs/ddd/workspace-audit/aggregates.md`
````
...
> **Canonical DDD reference:** `../../docs/ddd/workspace-feed/domain-services.md`

本文件對齊 `docs/ddd/workspace-feed/domain-services.md`，整理 `workspace-feed` 的 domain services 與相關設計約束。
...
- `../../docs/ddd/workspace-feed/domain-services.md`
- `../../docs/ddd/workspace-feed/aggregates.md`
````
...
````markdown
# workspace-flow — Domain Events

> **Canonical DDD reference:** `../../docs/ddd/workspace-flow/domain-events.md`

本文件對齊 `docs/ddd/workspace-flow/domain-events.md`，作為 `workspace-flow` 的事件程式碼入口索引。
...
- `../../docs/ddd/workspace-flow/domain-events.md`
- `../../docs/ddd/workspace-flow/context-map.md`
````
...
> **Canonical DDD reference:** `../../docs/ddd/workspace-scheduling/domain-services.md`

本文件對齊 `docs/ddd/workspace-scheduling/domain-services.md`，整理 `workspace-scheduling` 的 domain services 與相關設計約束。
...
- `../../docs/ddd/workspace-scheduling/domain-services.md`
- `../../docs/ddd/workspace-scheduling/aggregates.md`
````
...
> **Canonical DDD reference:** `../../docs/ddd/workspace/aggregates.md`

本文件對齊 `docs/ddd/workspace/aggregates.md`，作為 `workspace` 在模組目錄中的聚合根 / 實體 / 值物件索引。

## 設計摘要

- `workspace` 的聚合設計、生命週期與不變數以 canonical DDD 文件為準
- 模組內部程式碼導覽以下列路徑為主
...
> **Canonical DDD reference:** `../../docs/ddd/workspace/domain-services.md`

本文件對齊 `docs/ddd/workspace/domain-services.md`，整理 `workspace` 的 domain services 與相關設計約束。
