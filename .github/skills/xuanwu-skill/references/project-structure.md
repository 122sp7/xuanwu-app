      ...
      adapters/
        inbound/
          react/
            ...
            NotebooklmSourcesSection.tsx (52 lines)
          server-actions/
      ...
      adapters/
        inbound/
          react/
            ...
            WorkspaceFilesSection.tsx (19 lines)
            ...
            WorkspaceTaskFormationSection.tsx (41 lines)
            WorkspaceTasksSection.tsx (28 lines)
        outbound/
          firebase-composition.ts (81 lines)
      ...
      subdomains/
        ...
        task-formation/
          adapters/
            ...
            outbound/
              firestore/
                FirestoreTaskFormationJobRepository.ts (28 lines)
              index.ts (0 lines)
            index.ts (0 lines)
          application/
            dto/
              TaskFormationDTO.ts (3 lines)
            use-cases/
              TaskFormationUseCases.ts (15 lines)
            index.ts (0 lines)
          domain/
            entities/
              TaskFormationJob.ts (56 lines)
            events/
              TaskFormationDomainEvent.ts (13 lines)
            repositories/
