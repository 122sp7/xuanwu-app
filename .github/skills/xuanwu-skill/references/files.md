...
````json
{
  ...
  "scripts": {
    ...
    "deploy:functions": "npx firebase deploy --only functions:fn",
    "deploy:functions:fn": "npx firebase deploy --only functions:fn",
    "deploy:functions:all": "npx firebase deploy --only functions",
    "deploy:firebase": "npx firebase deploy",
    "repomix:all": "npm run repomix:skill && npm run repomix:ai && npm run repomix:analytics && npm run repomix:billing && npm run repomix:iam && npm run repomix:platform && npm run repomix:src && npm run repomix:fn && npm run repomix:packages && npm run repomix:markdown && npm run repomix:notebooklm && npm run repomix:notion && npm run repomix:workspace",
...
````json
{
  "compilerOptions": {
    ...
    "paths": {
      ...
      "@infra/client-state": ["./packages/infra/client-state/index.ts"],
      "@infra/http": ["./packages/infra/http/index.ts"],
      "@infra/query": ["./packages/infra/query/index.ts"],
      "@infra/serialization": ["./packages/infra/serialization/index.ts"],
      "@infra/state": ["./packages/infra/state/index.ts"],
      "@infra/trpc": ["./packages/infra/trpc/index.ts"],
      "@infra/uuid": ["./packages/infra/uuid/index.ts"],
      "@infra/zod": ["./packages/infra/zod/index.ts"],
      "@infra/date": ["./packages/infra/date/index.ts"],
      "@integration-ai": ["./packages/integration-ai/index.ts"],
      "@integration-queue": ["./packages/integration-queue/index.ts"],
      "@ui-components": ["./packages/ui-components/index.ts"],
      "@ui-editor": ["./packages/ui-editor/index.ts"],
      "@ui-markdown": ["./packages/ui-markdown/index.tsx"],
      "@ui-visualization": ["./packages/ui-visualization/index.tsx"],
      "@infra/form": ["./packages/infra/form/index.ts"],
      "@infra/table": ["./packages/infra/table/index.ts"],
      "@infra/virtual": ["./packages/infra/virtual/index.ts"],
      "@ui-dnd": ["./packages/ui-dnd/index.ts"],
