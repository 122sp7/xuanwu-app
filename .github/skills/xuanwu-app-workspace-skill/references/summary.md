...
304 files | 18,491 lines

| Language | Files | Lines |
|----------|------:|------:|
| TypeScript | 245 | 11,378 |
| TypeScript (TSX) | 41 | 6,550 |
| Markdown | 18 | 563 |
...
- `modules/workspace/interfaces/web/components/tabs/WorkspaceOverviewTab.tsx` (292 lines)
...
- `modules/workspace/interfaces/web/components/screens/AccountDashboardScreen.tsx` (272 lines)
