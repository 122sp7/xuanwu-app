...
app/(shell)/_shell/ShellDashboardSidebar.tsx (176 lines)
app/(shell)/_shell/ShellRootLayout.tsx (300 lines)
app/(shell)/_shell/ShellSidebarBody.tsx (197 lines)
app/(shell)/_shell/ShellSidebarHeader.tsx (52 lines)
app/(shell)/_shell/ShellSidebarNavData.tsx (118 lines)
...
app/(shell)/(account)/[accountId]/dashboard/page.tsx (53 lines)
app/(shell)/(account)/[accountId]/dev-tools/dev-tools-badges.tsx (59 lines)
app/(shell)/(account)/[accountId]/dev-tools/dev-tools-helpers.ts (133 lines)
...
app/(shell)/(account)/[accountId]/dev-tools/use-dev-tools-doc-list.ts (212 lines)
...
modules/notebooklm/infrastructure/source/platform/PlatformSourceDocumentWatchAdapter.ts (24 lines)
modules/notebooklm/infrastructure/source/platform/PlatformSourcePipelineAdapter.ts (90 lines)
modules/notebooklm/infrastructure/source/platform/PlatformSourceStorageAdapter.ts (26 lines)
...
modules/notebooklm/interfaces/source/components/SourceDocumentsPanel.tsx (187 lines)
modules/notebooklm/interfaces/source/components/WorkspaceFilesTab.tsx (229 lines)
modules/notebooklm/interfaces/source/composition/adapters.ts (63 lines)
modules/notebooklm/interfaces/source/composition/use-cases.ts (83 lines)
modules/notebooklm/interfaces/source/composition/wiki-library-facade.ts (57 lines)
modules/notebooklm/interfaces/source/contracts/source-command-result.ts (16 lines)
modules/notebooklm/interfaces/source/hooks/useSourceDocumentsSnapshot.ts (108 lines)
...
modules/notebooklm/subdomains/source/api/index.ts (115 lines)
modules/notebooklm/subdomains/source/api/server.ts (20 lines)
...
modules/notebooklm/subdomains/source/domain/ports/index.ts (21 lines)
...
modules/notebooklm/subdomains/source/domain/ports/ISourceDocumentWatchPort.ts (25 lines)
modules/notebooklm/subdomains/source/domain/ports/ISourcePipelinePort.ts (33 lines)
modules/notebooklm/subdomains/source/domain/ports/ISourceStoragePort.ts (20 lines)
...
modules/notion/api/index.ts (48 lines)
...
modules/notion/infrastructure/relations/firebase/FirebaseRelationRepository.ts (66 lines)
modules/notion/infrastructure/relations/firebase/index.ts (1 lines)
modules/notion/infrastructure/relations/index.ts (1 lines)
modules/notion/infrastructure/taxonomy/firebase/FirebaseTaxonomyRepository.ts (85 lines)
modules/notion/infrastructure/taxonomy/firebase/index.ts (1 lines)
modules/notion/infrastructure/taxonomy/index.ts (1 lines)
...
modules/notion/interfaces/authoring/composition/repositories.ts (10 lines)
modules/notion/interfaces/authoring/composition/use-cases.ts (49 lines)
...
modules/notion/interfaces/collaboration/composition/repositories.ts (15 lines)
modules/notion/interfaces/collaboration/composition/use-cases.ts (45 lines)
...
modules/notion/interfaces/database/composition/repositories.ts (20 lines)
modules/notion/interfaces/database/composition/use-cases.ts (74 lines)
...
modules/notion/interfaces/knowledge/components/KnowledgeDetailPanel.tsx (264 lines)
...
modules/notion/interfaces/knowledge/composition/repositories.ts (15 lines)
modules/notion/interfaces/knowledge/composition/use-cases.ts (85 lines)
...
modules/notion/interfaces/relations/_actions/.gitkeep (0 lines)
modules/notion/interfaces/relations/components/.gitkeep (0 lines)
modules/notion/interfaces/relations/composition/repositories.ts (5 lines)
modules/notion/interfaces/relations/composition/use-cases.ts (24 lines)
modules/notion/interfaces/relations/queries/.gitkeep (0 lines)
modules/notion/interfaces/relations/store/.gitkeep (0 lines)
modules/notion/interfaces/taxonomy/_actions/.gitkeep (0 lines)
modules/notion/interfaces/taxonomy/components/.gitkeep (0 lines)
modules/notion/interfaces/taxonomy/composition/repositories.ts (5 lines)
modules/notion/interfaces/taxonomy/composition/use-cases.ts (26 lines)
modules/notion/interfaces/taxonomy/queries/.gitkeep (0 lines)
modules/notion/interfaces/taxonomy/store/.gitkeep (0 lines)
modules/notion/README.md (128 lines)
modules/notion/subdomains/authoring/api/index.ts (42 lines)
modules/notion/subdomains/authoring/api/server.ts (12 lines)
...
modules/notion/subdomains/collaboration/api/server.ts (13 lines)
...
modules/notion/subdomains/collaboration/domain/events/index.ts (8 lines)
...
modules/notion/subdomains/collaboration/domain/services/index.ts (6 lines)
modules/notion/subdomains/collaboration/domain/value-objects/index.ts (6 lines)
modules/notion/subdomains/collaboration/README.md (29 lines)
modules/notion/subdomains/database/api/index.ts (103 lines)
modules/notion/subdomains/database/api/server.ts (14 lines)
...
modules/notion/subdomains/database/domain/events/index.ts (11 lines)
...
modules/notion/subdomains/database/domain/services/index.ts (6 lines)
modules/notion/subdomains/database/domain/value-objects/index.ts (6 lines)
modules/notion/subdomains/database/README.md (29 lines)
modules/notion/subdomains/knowledge/api/index.ts (84 lines)
modules/notion/subdomains/knowledge/api/server.ts (14 lines)
...
modules/notion/subdomains/relations/api/index.ts (36 lines)
modules/notion/subdomains/relations/api/server.ts (11 lines)
modules/notion/subdomains/relations/application/dto/RelationDto.ts (24 lines)
modules/notion/subdomains/relations/application/index.ts (7 lines)
modules/notion/subdomains/relations/application/use-cases/RelationUseCases.ts (52 lines)
...
modules/notion/subdomains/taxonomy/api/index.ts (37 lines)
modules/notion/subdomains/taxonomy/api/server.ts (11 lines)
modules/notion/subdomains/taxonomy/application/dto/TaxonomyDto.ts (24 lines)
modules/notion/subdomains/taxonomy/application/index.ts (7 lines)
modules/notion/subdomains/taxonomy/application/use-cases/TaxonomyUseCases.ts (70 lines)
...
modules/platform/application/services/shell-quick-create.ts (47 lines)
...
modules/platform/interfaces/web/index.ts (18 lines)
modules/platform/interfaces/web/providers/ShellAppContext.ts (74 lines)
...
modules/platform/interfaces/web/shell/search/ShellGlobalSearchDialog.tsx (119 lines)
modules/platform/platform.instructions.md (41 lines)
modules/platform/README.md (97 lines)
modules/platform/subdomains/access-control/api/index.ts (17 lines)
...
modules/platform/subdomains/access-control/application/services/shell-account-access.ts (44 lines)
...
modules/platform/subdomains/account-profile/api/index.ts (59 lines)
...
modules/platform/subdomains/account-profile/infrastructure/account-profile-service.ts (97 lines)
...
modules/platform/subdomains/account-profile/infrastructure/index.ts (13 lines)
...
modules/platform/subdomains/account/api/index.ts (32 lines)
...
modules/platform/subdomains/ai/api/index.ts (21 lines)
modules/platform/subdomains/ai/api/server.ts (32 lines)
modules/platform/subdomains/ai/application/index.ts (1 lines)
modules/platform/subdomains/ai/application/use-cases/generate-ai-text.use-case.ts (13 lines)
modules/platform/subdomains/ai/domain/index.ts (5 lines)
modules/platform/subdomains/ai/domain/ports/AiTextGenerationPort.ts (15 lines)
modules/platform/subdomains/ai/infrastructure/genkit/GenkitAiTextGenerationAdapter.ts (37 lines)
...
modules/platform/subdomains/identity/interfaces/index.ts (18 lines)
modules/platform/subdomains/identity/interfaces/providers/auth-provider.tsx (144 lines)
...
modules/platform/subdomains/organization/api/index.ts (75 lines)
...
modules/platform/subdomains/organization/infrastructure/organization-service.ts (142 lines)
...
modules/platform/subdomains/organization/interfaces/index.ts (26 lines)
...
modules/platform/subdomains/platform-config/application/services/shell-navigation-catalog.ts (277 lines)
...
modules/platform/subdomains/search/application/services/shell-command-catalog.ts (22 lines)
...
modules/platform/subdomains/subscription/domain/aggregates/Subscription.ts (152 lines)
...
modules/workspace/application/queries/wiki-content-tree.queries.ts (81 lines)
...
modules/workspace/interfaces/api/actions/workspace.command.ts (186 lines)
...
modules/workspace/interfaces/web/components/navigation/workspace-quick-access.tsx (142 lines)
...
modules/workspace/interfaces/web/components/screens/WorkspaceDetailScreen.tsx (296 lines)
modules/workspace/interfaces/web/components/screens/WorkspaceHubScreen.tsx (285 lines)
modules/workspace/interfaces/web/components/tabs/WorkspaceCrossModuleTabSurface.tsx (139 lines)
...
modules/workspace/interfaces/web/components/tabs/WorkspaceOverviewKnowledgePanels.tsx (99 lines)
...
modules/workspace/interfaces/web/hooks/useRecentWorkspaces.ts (120 lines)
modules/workspace/interfaces/web/hooks/useWorkspaceDetail.ts (90 lines)
modules/workspace/interfaces/web/hooks/useWorkspaceHub.ts (151 lines)
modules/workspace/interfaces/web/hooks/useWorkspaceOrchestrationContext.ts (58 lines)
modules/workspace/interfaces/web/hooks/useWorkspaceSettingsSave.ts (137 lines)
modules/workspace/interfaces/web/index.ts (64 lines)
modules/workspace/interfaces/web/navigation/nav-preferences-data.ts (238 lines)
modules/workspace/interfaces/web/navigation/use-sidebar-locale.ts (45 lines)
modules/workspace/interfaces/web/navigation/workspace-context-links.ts (87 lines)
modules/workspace/interfaces/web/navigation/workspace-nav-items.ts (41 lines)
modules/workspace/interfaces/web/navigation/workspace-tabs.ts (140 lines)
modules/workspace/interfaces/web/providers/WorkspaceContextProvider.tsx (159 lines)
...
modules/workspace/subdomains/audit/infrastructure/firebase/FirebaseAuditRepository.ts (82 lines)
...
modules/workspace/subdomains/feed/infrastructure/firebase/FirebaseWorkspaceFeedInteractionRepository.ts (74 lines)
modules/workspace/subdomains/feed/infrastructure/firebase/FirebaseWorkspaceFeedPostRepository.ts (202 lines)
...
modules/workspace/subdomains/scheduling/infrastructure/firebase/FirebaseDemandRepository.ts (101 lines)
...
modules/workspace/subdomains/scheduling/interfaces/components/CreateDemandForm.tsx (178 lines)
...
modules/workspace/subdomains/workspace-workflow/api/contracts.ts (94 lines)
modules/workspace/subdomains/workspace-workflow/api/factories.ts (20 lines)
modules/workspace/subdomains/workspace-workflow/api/index.ts (109 lines)
...
modules/workspace/subdomains/workspace-workflow/api/workspace-flow-task-batch-job.facade.ts (42 lines)
...
modules/workspace/subdomains/workspace-workflow/application/dto/workflow.dto.ts (13 lines)
...
modules/workspace/subdomains/workspace-workflow/application/ports/TaskCandidateExtractionAiPort.ts (21 lines)
...
modules/workspace/subdomains/workspace-workflow/application/services/TaskCandidateRuleExtractor.ts (69 lines)
...
modules/workspace/subdomains/workspace-workflow/application/use-cases/extract-task-candidates-from-knowledge.use-case.ts (77 lines)
...
modules/workspace/subdomains/workspace-workflow/application/use-cases/submit-task-materialization-batch-job.use-case.ts (43 lines)
...
modules/workspace/subdomains/workspace-workflow/domain/repositories/TaskMaterializationBatchJobRepository.ts (23 lines)
...
modules/workspace/subdomains/workspace-workflow/domain/value-objects/TaskMaterializationBatchJobStatus.ts (17 lines)
...
modules/workspace/subdomains/workspace-workflow/infrastructure/firebase/task-materialization-batch-job.converter.ts (45 lines)
modules/workspace/subdomains/workspace-workflow/infrastructure/firebase/task.converter.ts (39 lines)
modules/workspace/subdomains/workspace-workflow/infrastructure/firebase/workspace-flow.collections.ts (23 lines)
...
modules/workspace/subdomains/workspace-workflow/infrastructure/repositories/FirebaseTaskMaterializationBatchJobRepository.ts (106 lines)
...
modules/workspace/subdomains/workspace-workflow/interfaces/_actions/workspace-flow-task-batch-job.actions.ts (52 lines)
modules/workspace/subdomains/workspace-workflow/interfaces/_actions/workspace-flow-task.actions.ts (77 lines)
modules/workspace/subdomains/workspace-workflow/interfaces/_actions/workspace-flow.actions.ts (52 lines)
...
modules/workspace/subdomains/workspace-workflow/interfaces/contracts/workspace-flow.contract.ts (112 lines)
modules/workspace/subdomains/workspace-workflow/interfaces/queries/workspace-flow.queries.ts (83 lines)
