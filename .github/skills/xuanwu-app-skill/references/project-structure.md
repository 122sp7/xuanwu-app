    ...
    (account)/
      [accountId]/
        ...
        organization/
          audit/
            _components/
              OrganizationAuditPage.tsx (32 lines)
            page.tsx (5 lines)
          content/
            page.tsx (9 lines)
          daily/
...
modules/
  notebooklm/
    ...
    infrastructure/
      ...
      notebook/
        platform/
          PlatformTextGenerationAdapter.ts (21 lines)
      source/
        adapters/
          NotionKnowledgePageGatewayAdapter.ts (64 lines)
        firebase/
          FirebaseDocumentStatusAdapter.ts (20 lines)
          ...
          FirebaseSourceFileAdapter.ts (37 lines)
      ...
      synthesis/
        ...
        platform/
          PlatformRagGenerationAdapter.ts (33 lines)
        index.ts (4 lines)
    interfaces/
      conversation/
        _actions/
      ...
      source/
        _actions/
          source-file.actions.ts (42 lines)
          source-pipeline.actions.ts (20 lines)
          source-processing.actions.ts (46 lines)
        components/
          file-processing-dialog.body.tsx (21 lines)
          ...
          FileProcessingDialog.tsx (33 lines)
          LibrariesPanel.tsx (26 lines)
          LibraryTablePanel.tsx (36 lines)
          SourceDocumentsPanel.tsx (26 lines)
          WorkspaceFilesTab.tsx (31 lines)
        composition/
          adapters.ts (40 lines)
          use-cases.ts (57 lines)
    ...
    subdomains/
      ...
      source/
        ...
        application/
          dto/
            ...
            source-processing.dto.ts (17 lines)
            source.dto.ts (4 lines)
          queries/
            source-file.queries.ts (15 lines)
          use-cases/
            create-knowledge-draft-from-source.use-case.ts (71 lines)
            delete-source-document.use-case.ts (28 lines)
            process-source-document-workflow.use-case.ts (42 lines)
            ...
            upload-init-source-file.use-case.ts (39 lines)
        ...
        domain/
          ...
          ports/
            index.ts (7 lines)
            IParsedDocumentPort.ts (14 lines)
            ISourceDocumentPort.ts (16 lines)
            ISourceDocumentWatchPort.ts (31 lines)
            ISourcePipelinePort.ts (36 lines)
            ISourceStoragePort.ts (25 lines)
          repositories/
            IRagDocumentRepository.ts (31 lines)
            ISourceFileRepository.ts (26 lines)
            IWikiLibraryRepository.ts (25 lines)
          services/
      ...
      synthesis/
        ...
        domain/
          ...
          ports/
            IChunkRetrievalPort.ts (24 lines)
            IFeedbackPort.ts (17 lines)
            IGenerationPort.ts (15 lines)
            IVectorStore.ts (69 lines)
          repositories/
            IKnowledgeContentRepository.ts (90 lines)
            IRagGenerationRepository.ts (15 lines)
            IRagQueryFeedbackRepository.ts (15 lines)
            IRagRetrievalRepository.ts (25 lines)
          services/
            ICitationBuilder.ts (27 lines)
    ...
    interfaces/
      authoring/
        _actions/
          ...
          index.ts (2 lines)
        components/
          ArticleDetailPanel.tsx (59 lines)
      ...
      knowledge/
        _actions/
          ...
          knowledge-page.actions.ts (60 lines)
        components/
        ...
        composition/
          repositories.ts (9 lines)
          use-cases.ts (54 lines)
        queries/
          index.ts (36 lines)
        store/
          block-editor.store.ts (48 lines)
      relations/
        composition/
    ...
    subdomains/
      authoring/
        ...
        application/
          dto/
            ...
            index.ts (0 lines)
          use-cases/
            ArticleLifecycleUseCases.ts (35 lines)
            ArticlePublicationUseCases.ts (17 lines)
            ArticleVerificationUseCases.ts (21 lines)
            CategoryUseCases.ts (35 lines)
            index.ts (0 lines)
        domain/
          aggregates/
            Article.ts (67 lines)
          ...
          ports/
            index.ts (6 lines)
          repositories/
            IArticleRepository.ts (33 lines)
            ICategoryRepository.ts (19 lines)
            index.ts (1 lines)
          services/
            index.ts (1 lines)
          value-objects/
      ...
      collaboration/
        ...
        application/
          dto/
            ...
            index.ts (0 lines)
          use-cases/
            CommentUseCases.ts (37 lines)
            index.ts (0 lines)
            PermissionUseCases.ts (22 lines)
            VersionUseCases.ts (22 lines)
        domain/
          aggregates/
            Comment.ts (34 lines)
            index.ts (0 lines)
          ...
          ports/
            index.ts (6 lines)
          repositories/
            ICommentRepository.ts (61 lines)
            index.ts (0 lines)
            IPermissionRepository.ts (32 lines)
            IVersionRepository.ts (30 lines)
          services/
            index.ts (5 lines)
          value-objects/
            index.ts (5 lines)
      ...
      database/
        ...
        application/
          ...
          use-cases/
            AutomationUseCases.ts (24 lines)
            DatabaseUseCases.ts (29 lines)
            index.ts (0 lines)
            RecordUseCases.ts (25 lines)
            ViewUseCases.ts (25 lines)
        domain/
          aggregates/
          ...
          ports/
            index.ts (6 lines)
          repositories/
            IAutomationRepository.ts (47 lines)
            IDatabaseRecordRepository.ts (34 lines)
            IDatabaseRepository.ts (49 lines)
            index.ts (0 lines)
            IViewRepository.ts (38 lines)
          services/
            index.ts (5 lines)
          value-objects/
            index.ts (5 lines)
      ...
      knowledge/
        ...
        application/
          ...
          use-cases/
            index.ts (0 lines)
            KnowledgeCollectionUseCases.ts (40 lines)
            KnowledgePageAppearanceUseCases.ts (25 lines)
            KnowledgePageReviewUseCases.ts (47 lines)
            KnowledgePageUseCases.ts (47 lines)
        domain/
          aggregates/
            BacklinkIndex.ts (32 lines)
            ContentBlock.ts (65 lines)
            index.ts (0 lines)
            KnowledgeCollection.ts (89 lines)
            KnowledgePage.ts (106 lines)
          events/
            index.ts (0 lines)
          ...
          ports/
            index.ts (6 lines)
          repositories/
            IBacklinkIndexRepository.ts (31 lines)
            IContentBlockRepository.ts (21 lines)
            IKnowledgeCollectionRepository.ts (19 lines)
            IKnowledgePageRepository.ts (31 lines)
            index.ts (0 lines)
          services/
      ...
      relations/
        ...
        domain/
          ...
          repositories/
            IRelationRepository.ts (21 lines)
          index.ts (0 lines)
        README.md (29 lines)
      taxonomy/
        api/
        ...
        domain/
          ...
          repositories/
            ITaxonomyRepository.ts (21 lines)
          index.ts (0 lines)
        README.md (29 lines)
    AGENT.md (156 lines)
    README.md (128 lines)
  platform/
    api/
      ...
      contracts.ts (219 lines)
      facade.ts (78 lines)
      index.ts (23 lines)
      infrastructure-api.ts (90 lines)
      platform-service.ts (46 lines)
      server.ts (7 lines)
      service-api.ts (47 lines)
    application/
      dtos/
        index.ts (113 lines)
      ...
      services/
        ...
        build-correlation-id.ts (10 lines)
        index.ts (6 lines)
        shell-quick-create.ts (33 lines)
      use-cases/
    ...
    subdomains/
      access-control/
        ...
        application/
          ...
          use-cases/
            access-control.use-cases.ts (55 lines)
            index.ts (0 lines)
          index.ts (0 lines)
        domain/
          aggregates/
            AccessPolicy.ts (48 lines)
            index.ts (0 lines)
          events/
        ...
        infrastructure/
          ...
          access-control-service.ts (16 lines)
          index.ts (0 lines)
        README.md (13 lines)
      account/
        api/
        ...
        infrastructure/
          firebase/
            ...
            FirebaseAccountRepository.ts (50 lines)
          account-service.ts (41 lines)
          identity-token-refresh.adapter.ts (14 lines)
          index.ts (0 lines)
        interfaces/
          _actions/
      ...
      account-profile/
        ...
        domain/
          aggregates/
            AccountProfileAggregate.ts (44 lines)
            index.ts (0 lines)
          entities/
          ...
          index.ts (0 lines)
        infrastructure/
          account-profile-service.ts (49 lines)
        ...
        interfaces/
          ...
          components/
            screens/
              SettingsProfileRouteScreen.tsx (25 lines)
          queries/
      ...
      background-job/
        ...
        application/
          use-cases/
            ingestion.use-cases.ts (67 lines)
          index.ts (0 lines)
        domain/
          entities/
            IngestionChunk.ts (21 lines)
            IngestionDocument.ts (18 lines)
            IngestionJob.ts (66 lines)
          events/
            index.ts (0 lines)
          ...
          ports/
            index.ts (7 lines)
          repositories/
            IIngestionJobRepository.ts (50 lines)
          index.ts (0 lines)
        infrastructure/
          index.ts (0 lines)
          ingestion-service.ts (49 lines)
          InMemoryIngestionJobRepository.ts (31 lines)
        README.md (13 lines)
      billing/
        api/
          index.ts (4 lines)
      ...
      entitlement/
        ...
        application/
          dtos/
            ...
            index.ts (0 lines)
          use-cases/
            entitlement.use-cases.ts (42 lines)
            index.ts (0 lines)
          index.ts (0 lines)
        domain/
          aggregates/
            EntitlementGrant.ts (48 lines)
            index.ts (0 lines)
          events/
        ...
        infrastructure/
          ...
          entitlement-service.ts (15 lines)
          index.ts (0 lines)
        README.md (14 lines)
      feature-flag/
        api/
      ...
      identity/
        ...
        infrastructure/
          ...
          identity-service.ts (46 lines)
          index.ts (0 lines)
        interfaces/
          _actions/
            identity.actions.ts (20 lines)
          components/
      ...
      notification/
        ...
        domain/
          aggregates/
            index.ts (0 lines)
            NotificationAggregate.ts (45 lines)
          entities/
        ...
        infrastructure/
          ...
          index.ts (0 lines)
          notification-service.ts (16 lines)
        interfaces/
          _actions/
      ...
      organization/
        ...
        domain/
          ...
          ports/
            index.ts (0 lines)
            IOrganizationTeamPort.ts (24 lines)
          repositories/
        ...
        infrastructure/
          ...
          index.ts (0 lines)
          organization-service.ts (60 lines)
        interfaces/
          _actions/
      ...
      subscription/
        ...
        application/
          ...
          use-cases/
            index.ts (0 lines)
            subscription.use-cases.ts (42 lines)
          index.ts (0 lines)
        domain/
          aggregates/
            index.ts (0 lines)
            Subscription.ts (54 lines)
          events/
            index.ts (0 lines)
        ...
        infrastructure/
          ...
          index.ts (0 lines)
          subscription-service.ts (15 lines)
        README.md (13 lines)
      support/
        api/
          index.ts (4 lines)
  ...
  workspace/
    ...
    application/
      ...
      queries/
        wiki-content-tree.queries.ts (27 lines)
    ...
    infrastructure/
      ...
      firebase/
        ...
        FirebaseWorkspaceRepository.ts (68 lines)
      infrastructure.instructions.md (22 lines)
    interfaces/
      api/
        actions/
          workspace.command.ts (55 lines)
        contracts/
          index.ts (5 lines)
      ...
      web/
        components/
          ...
          navigation/
            workspace-quick-access.tsx (21 lines)
          rails/
          ...
          screens/
            ...
            WorkspaceDetailScreen.tsx (62 lines)
            WorkspaceHubScreen.tsx (45 lines)
          tabs/
            WorkspaceCrossModuleTabSurface.tsx (29 lines)
            WorkspaceDailyTab.tsx (8 lines)
            WorkspaceMembersTab.tsx (25 lines)
    ...
    subdomains/
      audit/
        ...
        application/
          ...
          use-cases/
            record-audit-entry.use-case.ts (9 lines)
        domain/
          aggregates/
            AuditEntry.ts (91 lines)
            index.ts (0 lines)
          entities/
        ...
        infrastructure/
          firebase/
            FirebaseAuditRepository.ts (19 lines)
        interfaces/
          components/
      ...
      scheduling/
        ...
        application/
          dto/
            work-demand.dto.ts (22 lines)
          work-demand.use-cases.ts (30 lines)
        domain/
        ...
        infrastructure/
          ...
          mock-demand-repository.ts (14 lines)
        interfaces/
          _actions/
      ...
      workspace-workflow/
        ...
        application/
          dto/
            ...
            extract-task-candidates-from-knowledge.dto.ts (34 lines)
          ...
          process-managers/
            knowledge-to-workflow-materializer.ts (60 lines)
          services/
            TaskCandidateRuleExtractor.ts (18 lines)
          use-cases/
