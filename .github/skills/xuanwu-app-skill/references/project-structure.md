...
app/
  ...
  (shell)/
    _components/
      ...
      app-rail.tsx (567 lines)
      customize-navigation-dialog.tsx (611 lines)
      dashboard-sidebar.tsx (990 lines)
      global-search-dialog.tsx (96 lines)
      header-controls.tsx (58 lines)
...
docs/
  ddd/
    ...
    bounded-contexts.md (95 lines)
    subdomains.md (129 lines)
  development/
...
modules/
  ...
  knowledge/
    ...
    application/
      dto/
        knowledge.dto.ts (232 lines)
      use-cases/
        knowledge-block.use-cases.ts (73 lines)
        knowledge-collection.use-cases.ts (176 lines)
        knowledge-page.use-cases.ts (297 lines)
        knowledge-version.use-cases.ts (43 lines)
      block-service.ts (59 lines)
    domain/
      entities/
        content-block.entity.ts (35 lines)
        content-page.entity.ts (112 lines)
        content-version.entity.ts (31 lines)
        knowledge-collection.entity.ts (104 lines)
      events/
        knowledge.events.ts (154 lines)
      repositories/
        knowledge.repositories.ts (80 lines)
      value-objects/
    ...
    infrastructure/
      firebase/
        ...
        FirebaseContentCollectionRepository.ts (228 lines)
        FirebaseContentPageRepository.ts (294 lines)
      index.ts (7 lines)
      InMemoryKnowledgeRepository.ts (231 lines)
    interfaces/
      _actions/
        knowledge.actions.ts (308 lines)
      components/
        BlockEditorView.tsx (355 lines)
        PageDialog.tsx (96 lines)
        PageTreeView.tsx (167 lines)
      queries/
        knowledge.queries.ts (78 lines)
      store/
        block-editor.store.ts (83 lines)
      index.ts (26 lines)
    AGENT.md (66 lines)
    aggregates.md (89 lines)
    application-services.md (45 lines)
    context-map.md (68 lines)
    domain-events.md (37 lines)
    domain-services.md (40 lines)
    index.ts (91 lines)
    README.md (66 lines)
    repositories.md (71 lines)
  ...
  knowledge-base/
    ...
    application/
      dto/
        knowledge-base.dto.ts (85 lines)
      use-cases/
        article.use-cases.ts (175 lines)
        category.use-cases.ts (107 lines)
    domain/
      entities/
        article.entity.ts (23 lines)
        category.entity.ts (14 lines)
      repositories/
        ArticleRepository.ts (18 lines)
        CategoryRepository.ts (10 lines)
      services/
        BacklinkExtractorService.ts (11 lines)
      index.ts (9 lines)
    infrastructure/
      firebase/
        FirebaseArticleRepository.ts (133 lines)
        FirebaseCategoryRepository.ts (101 lines)
    interfaces/
      _actions/
        knowledge-base.actions.ts (128 lines)
      components/
  ...
  knowledge-collaboration/
    ...
    application/
      dto/
        knowledge-collaboration.dto.ts (79 lines)
      use-cases/
        comment.use-cases.ts (72 lines)
        permission.use-cases.ts (52 lines)
        version.use-cases.ts (46 lines)
    domain/
      entities/
        comment.entity.ts (14 lines)
        permission.entity.ts (15 lines)
        version.entity.ts (12 lines)
      repositories/
        ICommentRepository.ts (37 lines)
        IPermissionRepository.ts (26 lines)
        IVersionRepository.ts (24 lines)
    infrastructure/
      firebase/
        FirebaseCommentRepository.ts (110 lines)
        FirebasePermissionRepository.ts (89 lines)
        FirebaseVersionRepository.ts (81 lines)
    interfaces/
      _actions/
        knowledge-collaboration.actions.ts (83 lines)
      components/
        CommentPanel.tsx (198 lines)
        VersionHistoryPanel.tsx (96 lines)
      queries/
        knowledge-collaboration.queries.ts (26 lines)
    AGENT.md (27 lines)
    aggregates.md (89 lines)
  ...
  knowledge-database/
    ...
    application/
      dto/
        knowledge-database.dto.ts (109 lines)
      use-cases/
        database.use-cases.ts (80 lines)
        record.use-cases.ts (57 lines)
        view.use-cases.ts (64 lines)
    domain/
      entities/
        database.entity.ts (36 lines)
        record.entity.ts (11 lines)
        view.entity.ts (33 lines)
      repositories/
        IDatabaseRecordRepository.ts (28 lines)
        IDatabaseRepository.ts (38 lines)
        IViewRepository.ts (34 lines)
    infrastructure/
      firebase/
        FirebaseDatabaseRepository.ts (141 lines)
        FirebaseRecordRepository.ts (102 lines)
        FirebaseViewRepository.ts (127 lines)
    interfaces/
      _actions/
        knowledge-database.actions.ts (113 lines)
      components/
        DatabaseDialog.tsx (109 lines)
        DatabaseTableView.tsx (259 lines)
      queries/
        knowledge-database.queries.ts (32 lines)
    AGENT.md (33 lines)
  ...
  notification/
    api/
      index.ts (24 lines)
      notification.facade.ts (57 lines)
    application/
      use-cases/
    ...
    interfaces/
      ...
      components/
        NotificationBell.tsx (175 lines)
      queries/
  ...
  source/
    ...
    infrastructure/
      firebase/
        ...
        FirebaseWikiLibraryRepository.ts (221 lines)
      repositories/
  ...
  workspace/
    ...
    interfaces/
      ...
      components/
        ...
        WorkspaceDetailScreen.tsx (1112 lines)
        WorkspaceHubScreen.tsx (326 lines)
...
scripts/
  demo-flow.ts (49 lines)
  init-framework.sh (492 lines)
.firebaserc (5 lines)
