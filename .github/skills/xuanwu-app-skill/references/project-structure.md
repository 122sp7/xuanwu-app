...
modules/workspace/interfaces/web/hooks/useWorkspaceOrchestrationContext.ts (45 lines)
...
modules/workspace/interfaces/web/navigation/nav-preferences-data.ts (191 lines)
