...
modules/platform/application/services/.gitkeep (0 lines)
...
modules/platform/application/services/index.ts (9 lines)
...
modules/platform/application/use-cases/get-platform-context-view.use-cases.ts (17 lines)
modules/platform/application/use-cases/get-policy-catalog-view.use-cases.ts (17 lines)
modules/platform/application/use-cases/get-subscription-entitlements.use-cases.ts (17 lines)
modules/platform/application/use-cases/get-workflow-policy-view.use-cases.ts (17 lines)
modules/platform/application/use-cases/index.ts (38 lines)
modules/platform/application/use-cases/list-enabled-capabilities.use-cases.ts (18 lines)
