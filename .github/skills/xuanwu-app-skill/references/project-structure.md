...
modules/
  ...
  knowledge/
    ...
    interfaces/
      ...
      index.ts (26 lines)
    AGENT.md (52 lines)
    aggregates.md (125 lines)
    application-services.md (58 lines)
    ...
    ubiquitous-language.md (73 lines)
  knowledge-base/
    api/
      index.ts (40 lines)
    application/
