...
app/
  ...
  (shell)/
    _components/
      ...
      global-search-dialog.tsx (91 lines)
...
docs/
  ddd/
    ...
    bounded-contexts.md (236 lines)
    subdomains.md (204 lines)
  development/
...
modules/
  account/
    ...
    ports/
      .gitkeep (0 lines)
    AGENT.md (57 lines)
    aggregates.md (22 lines)
    application-services.md (21 lines)
    context-map.md (21 lines)
    domain-events.md (19 lines)
    domain-services.md (19 lines)
    index.ts (74 lines)
    README.md (55 lines)
    repositories.md (26 lines)
    ubiquitous-language.md (23 lines)
  ai/
    ...
    .gitkeep (0 lines)
    AGENT.md (67 lines)
    aggregates.md (25 lines)
    application-services.md (22 lines)
    context-map.md (21 lines)
    domain-events.md (19 lines)
    domain-services.md (19 lines)
    README.md (89 lines)
    repositories.md (24 lines)
    ubiquitous-language.md (26 lines)
  identity/
    api/
      index.ts (59 lines)
  ...
  knowledge/
    ...
    application-services.md (25 lines)
    context-map.md (21 lines)
    domain-events.md (19 lines)
    domain-services.md (19 lines)
    index.ts (66 lines)
    README.md (97 lines)
    repositories.md (28 lines)
    ubiquitous-language.md (27 lines)
  notebook/
    api/
      index.ts (41 lines)
    application/
  ...
  notification/
    ...
    AGENT.md (57 lines)
    aggregates.md (21 lines)
    application-services.md (20 lines)
    context-map.md (21 lines)
    domain-events.md (19 lines)
    domain-services.md (19 lines)
    index.ts (21 lines)
    README.md (72 lines)
    repositories.md (22 lines)
    ubiquitous-language.md (22 lines)
  organization/
    api/
      index.ts (94 lines)
  ...
  wiki/
    ...
    application/
      use-cases/
        auto-link.use-case.ts (74 lines)
  ...
  workspace/
    ...
    interfaces/
      ...
      components/
        ...
        WorkspaceDetailScreen.tsx (971 lines)
  ...
  workspace-flow/
    ...
    README.md (152 lines)
    repositories.md (33 lines)
    ubiquitous-language.md (36 lines)
