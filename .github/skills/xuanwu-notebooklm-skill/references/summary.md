...
57 files | 1,674 lines

| Language | Files | Lines |
|----------|------:|------:|
| TypeScript | 45 | 905 |
| Markdown | 8 | 642 |
| TypeScript (TSX) | 4 | 127 |
...
- `src/modules/notebooklm/subdomains/document/adapters/outbound/firestore/FirestoreDocumentRepository.ts` (94 lines)
...
- `src/modules/notebooklm/adapters/outbound/firebase-composition.ts` (71 lines)
