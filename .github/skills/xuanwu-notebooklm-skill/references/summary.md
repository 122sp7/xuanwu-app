...
64 files | 1,955 lines

| Language | Files | Lines |
|----------|------:|------:|
| TypeScript | 52 | 1,105 |
| Markdown | 8 | 642 |
| TypeScript (TSX) | 4 | 208 |

**Largest files:**
- `src/modules/notebooklm/adapters/inbound/react/NotebooklmSourcesSection.tsx` (137 lines)
- `src/modules/notebooklm/subdomains/source/domain/entities/IngestionSource.ts` (118 lines)
...
- `src/modules/notebooklm/adapters/inbound/server-actions/document-actions.ts` (75 lines)