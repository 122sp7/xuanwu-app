...
- `src/modules/workspace/adapters/outbound/firebase-composition.ts` (159 lines)
- `docs/structure/contexts/workspace/README.md` (126 lines)
- `docs/structure/contexts/workspace/ubiquitous-language.md` (119 lines)
- `src/modules/workspace/adapters/inbound/react/WorkspaceIssuesSection.tsx` (115 lines)
- `docs/structure/contexts/workspace/AGENTS.md` (97 lines)
- `src/modules/workspace/adapters/inbound/react/WorkspaceDailySection.tsx` (94 lines)