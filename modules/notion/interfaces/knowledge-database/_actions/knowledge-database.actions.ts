...
import type { CreateAutomationInput, UpdateAutomationInput } from "../../../subdomains/knowledge-database/application/dto/knowledge-database.dto";
import type {
  CreateDatabaseDto,
  UpdateDatabaseDto,
  AddFieldDto,
  ...
  UpdateViewDto,
  DeleteViewDto,
} from "../../../subdomains/knowledge-database/application/dto/DatabaseDto";
