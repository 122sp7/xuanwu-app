...
export interface WorkspaceAcceptanceGate {
  readonly id: string;
  readonly label: string;
...
export function getWorkspaceAcceptanceGates(workspace: WorkspaceEntity): WorkspaceAcceptanceGate[] {
  const gates: WorkspaceAcceptanceGate[] = [
    {
      id: "lifecycle-state",
