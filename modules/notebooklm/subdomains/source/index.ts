 ...
 * Layer: subdomain barrel
 * Purpose: Internal aggregate export for the source subdomain.
 *
 * Components, hooks, queries, and actions within this subdomain
 * import from here via `../../index` or `../index`.
 *
 * Cross-module access MUST use `modules/notebooklm/api/` instead of this file.
 */
