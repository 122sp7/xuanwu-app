...
.github/agents/
  ...
  genkit-flow.agent.md             ⚠️ MERGE → ai-genkit-lead
                                        ↳ 循環 handoff 異味：genkit-flow ↔ ai-genkit-lead 互指
  genkit-orchestrator.agent.md     ⚠️ STRIP + MERGE → ai-genkit-lead
                                        ↳ STRIP 先：6條 Hard Rules + AI Flow 審查清單
                                        ↳ → genkit-flow.instructions.md（確認缺口後補入）

  # ── 架構 / DDD 域 ────────────────────────────────────────────
  hexagonal-ddd-architect.agent.md ✅  Hexagonal DDD 設計主責
  hexagonal-convergence-enforcer.agent.md
                                   ⚠️ STRIP  內嵌操作程序：
                                        ↳ Context7 Certainty Gate → context7/SKILL.md
                                        ↳ Repomix Explorer Source Policy → repomix/SKILL.md
                                        ↳ Serena Troubleshooting → serena-mcp/SKILL.md
  domain-architect.agent.md        ✅  Domain modeling 主責（審查清單屬可接受的 compositional guide）
  architecture-enforcer.agent.md   ⚠️ STRIP + MERGE → hexagonal-convergence-enforcer
                                        ↳ STRIP 先：4節審查清單（複製 architecture-core.instructions.md）
  domain-enforcer.agent.md         ⚠️ STRIP + MERGE → hexagonal-convergence-enforcer
                                        ↳ STRIP 先：8條 Hard Violations（複製 domain-layer-rules.instructions.md）
