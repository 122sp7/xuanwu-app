...
.github/agents/
  ...
  genkit-flow.agent.md             ⚠️ MERGE → ai-genkit-lead  語意完全覆蓋
  genkit-orchestrator.agent.md     ⚠️ MERGE → ai-genkit-lead  語意完全覆蓋

  # ── 架構 / DDD 域 ────────────────────────────────────────────
  hexagonal-ddd-architect.agent.md ✅  Hexagonal DDD 設計主責
  hexagonal-convergence-enforcer.agent.md ✅  架構收斂 + 異味偵測主責
  domain-architect.agent.md        ✅  Domain modeling 主責
  architecture-enforcer.agent.md   ⚠️ MERGE → hexagonal-convergence-enforcer  收斂職責重疊
  domain-enforcer.agent.md         ⚠️ MERGE → hexagonal-convergence-enforcer  邊界強制重疊
  domain-lead.agent.md             ⚠️ MERGE → domain-architect  角色語意重疊

  # ── Frontend 域 ──────────────────────────────────────────────
  app-router.agent.md              ✅  Next.js App Router 專責
  frontend-lead.agent.md           ✅  前端技術主責
  shadcn-composer.agent.md         ✅  shadcn/UI 組裝專責
  state-management.agent.md        ✅  Zustand / XState 狀態管理

  # ── Firebase / 資料層 ─────────────────────────────────────────
  firebase-guardian.agent.md       ✅  Firebase 規則守護
  ...
  ts-interface-writer.agent.md     ✅  TypeScript interface 產出
  zod-validator.agent.md           ✅  Zod schema 設計
  ...
  # ── 錯置檔案（需搬移）────────────────────────────────────────
  commands.md                      ❌ MOVE → docs/tooling/commands-reference.md
                                      類型：工具型（Tooling）；非 agent
  knowledge-base.md                ❌ MOVE → docs/tooling/knowledge-base-reference.md
                                      類型：工具型（Tooling）；非 agent
```

### agents 合併後目標清單（共 22 個）
...
| 原路徑 | 目標路徑 | 原因 |
|--------|---------|------|
| `.github/agents/commands.md` | `docs/tooling/commands-reference.md` | 工具型文件，非 agent |
| `.github/agents/knowledge-base.md` | `docs/tooling/knowledge-base-reference.md` | 工具型文件，非 agent |

### 🟡 建議：合併語意重疊 agents

| 被合併（刪除） | 合併目標 | 重疊理由 |
|-------------|---------|---------|
| `genkit-flow.agent.md` | `ai-genkit-lead.agent.md` | Genkit 流程職責完全涵蓋 |
| `genkit-orchestrator.agent.md` | `ai-genkit-lead.agent.md` | Genkit 編排職責完全涵蓋 |
| `architecture-enforcer.agent.md` | `hexagonal-convergence-enforcer.agent.md` | 架構強制職責完全涵蓋 |
| `domain-enforcer.agent.md` | `hexagonal-convergence-enforcer.agent.md` | 邊界強制職責完全涵蓋 |
