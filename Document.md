...
.github/agents/
  ...
  state-management.agent.md        ✅  狀態管理主責（Decision Rule + Guardrails 已 STRIP → state-management.instructions.md）

  # ── Firebase / 資料層 ─────────────────────────────────────────
  firebase-guardian.agent.md       ✅  Firebase 邊界守護（內嵌規則已 STRIP → firestore-schema.instructions.md + security-rules.instructions.md）
  ...
  ts-interface-writer.agent.md     ✅  TypeScript interface 設計（scope 已修正為 src/modules/**/application/dto/**）
  zod-validator.agent.md           ✅  Zod validation 主責（Hard Rules + Guardrails 已 STRIP → architecture-core.instructions.md）
  ...
  # ── 錯置 / 重複檔案（已處置）─────────────────────────────
  # commands.md          ✅ MOVED → docs/tooling/commands-reference.md（已刪除原檔）
  # knowledge-base.md    ✅ MOVED → docs/tooling/knowledge-base-reference.md（已刪除原檔）
```

### agents 現況清單（共 25 個）

> 完成所有 STRIP + MERGE 作業後，當前 25 個語意不重疊的 agent。
...
> 所有 STRIP 作業已完成（firebase-guardian、state-management、hexagonal-convergence-enforcer、zod-validator、ts-interface-writer）。
...
> **待處置**：`browser-use` 與 `agent-browser` 語意重疊，建議合並入 `agent-browser`（尚未完成）。
...
| 原路徑 | 處置 | 狀態 |
|--------|------|------|
| `.github/agents/commands.md` | body → `docs/tooling/commands-reference.md`；原檔刪除 | ✅ Done |
| `.github/agents/knowledge-base.md` | body → `docs/tooling/knowledge-base-reference.md`；原檔刪除 | ✅ Done |

### ✅ 已完成：提取 agent 內嵌規則（STRIP — 解除類型污染）

| Agent | 提取至 | 狀態 |
|-------|--------|------|
| `hexagonal-convergence-enforcer.agent.md` | `context7/SKILL.md`、`repomix/SKILL.md`、`serena-mcp/SKILL.md` | ✅ Done |
| `genkit-orchestrator.agent.md` | `genkit-flow.instructions.md` | ✅ Done（已刪除） |
| `architecture-enforcer.agent.md` | `architecture-core.instructions.md` | ✅ Done（已刪除） |
| `domain-enforcer.agent.md` | `domain-layer-rules.instructions.md` | ✅ Done（已刪除） |
| `firebase-guardian.agent.md` | `firestore-schema.instructions.md` + `security-rules.instructions.md` | ✅ Done |
| `state-management.agent.md` | `state-management.instructions.md` | ✅ Done |
| `zod-validator.agent.md` | `architecture-core.instructions.md`（Zod section） | ✅ Done |
| `ts-interface-writer.agent.md` | scope 路徑修正為 `src/modules/**/application/dto/**` | ✅ Done |

### ✅ 已完成：合併語意重疊 agents

| 被合併（已刪除） | 合併目標 | 狀態 |
|-------------|---------|------|
| `genkit-flow.agent.md` | `ai-genkit-lead.agent.md` | ✅ Done |
| `genkit-orchestrator.agent.md` | `ai-genkit-lead.agent.md` | ✅ Done |
| `architecture-enforcer.agent.md` | `hexagonal-convergence-enforcer.agent.md` | ✅ Done |
| `domain-enforcer.agent.md` | `hexagonal-convergence-enforcer.agent.md` | ✅ Done |
| `domain-lead.agent.md` | `domain-architect.agent.md` | ✅ Done |
...
### ✅ 已完成：instructions applyTo 精確化

| 檔案 | 狀態 |
|------|------|
| `lint-format.instructions.md` | ✅ 已確認 applyTo 正確 |
